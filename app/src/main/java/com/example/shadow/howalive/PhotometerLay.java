 ...
 */
public class PhotometerLay extends RelativeLayout {
    ...
    public PhotometerLay(Context context)
    {
        super(context,null);
    }
    public PhotometerLay(Context context,AttributeSet attributeSet)
    {
        super(context,attributeSet);

        LayoutInflater.from(context).inflate(R.layout.photometer_lay, this, true);

        this.scale1 = (ImageView) findViewById(R.id.light_scale1);
        this.scale2 = (ImageView) findViewById(R.id.light_scale2);
        this.scale3 = (ImageView) findViewById(R.id.light_scale3);
        this.scale4 = (ImageView) findViewById(R.id.light_scale4);
        this.scale5 = (ImageView) findViewById(R.id.light_scale5);
        this.scale6 = (ImageView) findViewById(R.id.light_scale6);
        this.scale7 = (ImageView) findViewById(R.id.light_scale7);
        this.scale8 = (ImageView) findViewById(R.id.light_scale8);
        this.scale9 = (ImageView) findViewById(R.id.light_scale9);
        this.scale10 = (ImageView) findViewById(R.id.light_scale10);
